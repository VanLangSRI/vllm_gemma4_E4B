...
# Threshold is a fraction of what the patch actually adds. The old floor of 3
# made small patches unverifiable: flashinfer-fa2-sm86-fp8-kv.patch adds a single
# substantial line, so it always reported NOT-APPLIED even when correctly applied.
sys.exit(0 if hits >= max(1, int(0.8 * len(added))) else 1)
